...
public class BlogWorkflowTests extends BaseTest {
    ...
    @Test(groups = {"regression"}, priority = 1, 
          description = "Validates email formats in all comments for user's blog posts")
    public void validateEmailFormatsInUserBlogComments() {
        ...
        log.info("Successfully validated {} comments across {} posts for user '{}'", 
                validatedCommentsCount, userPosts.size(), TARGET_USERNAME);
    }
}